...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getBiddedItemsByWalletAddress: async (
     ...
     * @throws {RequiredError}
     */
    getBoughtItemStocksByWalletAddress: async (
      mintAccessToken: string,
      walletAddress: string,
      options: any = {}
    ): Promise<RequestArgs> => {
    ...
    getItemById: async (
      ...
      const localVarPath = `/sdk_v4/items/{itemId}`.replace(
        `{${'itemId'}}`,
     ...
     * @throws {RequiredError}
     */
    getItemStockDetailERC721Shop: async (
      mintAccessToken: string,
      itemId: string,
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getTokenERC721sByWalletAddress: async (
      mintAccessToken: string,
      walletAddress: string,
      options: any = {}
    ): Promise<RequestArgs> => {
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getBiddedItemsByWalletAddress(
      mintAccessToken: string,
      walletAddress: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBiddedItemsByWalletAddress(
          mintAccessToken,
          walletAddress,
          options
        )
     ...
     * @throws {RequiredError}
     */
    async getBoughtItemStocksByWalletAddress(
      mintAccessToken: string,
      walletAddress: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getBoughtItemStocksByWalletAddress(
          mintAccessToken,
          walletAddress,
          options
        )
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getItemById(
        mintAccessToken,
        itemId,
        options
      )
     ...
     * @throws {RequiredError}
     */
    async getItemStockDetailERC721Shop(
      mintAccessToken: string,
      itemId: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getItemStockDetailERC721Shop(
          mintAccessToken,
          itemId,
          options
        )
     ...
     * @throws {RequiredError}
     */
    async getTokenERC721sByWalletAddress(
      mintAccessToken: string,
      walletAddress: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTokenERC721sByWalletAddress(
          mintAccessToken,
          walletAddress,
          options
        )
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    getBiddedItemsByWalletAddress(
      ...
      return localVarFp
        .getBiddedItemsByWalletAddress(mintAccessToken, walletAddress, options)
    ...
    getItemById(
      ...
      return localVarFp
        .getItemById(mintAccessToken, itemId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getItemStockDetailERC721Shop(
      ...
      return localVarFp
        .getItemStockDetailERC721Shop(mintAccessToken, itemId, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getItems(
      ...
      return localVarFp
        .getItems(mintAccessToken, options)
        .then((request) => request(axios, basePath))
    },
    /**
     *
    ...
    getTokenERC721sByWalletAddress(
      ...
      return localVarFp
        .getTokenERC721sByWalletAddress(mintAccessToken, walletAddress, options)
        .then((request) => request(axios, basePath))
    },
  }
}
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public getBiddedItemsByWalletAddress(
    mintAccessToken: string,
    walletAddress: string,
    options?: any
  ) {
   ...
   * @memberof DefaultApi
   */
  public getBoughtItemStocksByWalletAddress(
    mintAccessToken: string,
    walletAddress: string,
    options?: any
  ) {
   ...
   * @memberof DefaultApi
   */
  public getItemStockDetailERC721Shop(
    mintAccessToken: string,
    itemId: string,
    options?: any
  ) {
   ...
   * @memberof DefaultApi
   */
  public getTokenERC721sByWalletAddress(
    mintAccessToken: string,
    walletAddress: string,
    options?: any
  ) {
